...
export const discordLink = "https://discord.gg/6NRNqPPnwe";
export const dashboardLink = "https://gdvnps.ps.fhgdps.com/dashboard";
export const browserLink = "https://gdvnps.ps.fhgdps.com/browser/";
